...
public class NMSHandler implements mc.dailycraft.advancedspyinventory.nms.NMSHandler {
    private static Field careerLevelField, careerField, tradesField, localeField;
    ...
    public void setVillagerProfession(Villager villager, String profession) {
        try {
            if (careerLevelField == null)
                (careerLevelField = EntityVillager.class.getDeclaredField("bK")).setAccessible(true);
            if (tradesField == null)
    ...
    public String getPlayerLocale(Player player) {
        if (localeField == null) {
            try {
                (localeField = EntityPlayer.class.getDeclaredField("locale")).setAccessible(true);
